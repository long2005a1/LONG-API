...
layui.define(["layer"], function(f) {
    ...
    n.events = {
        ...
        theme: function() {
            ...
            n.strToWin(i.window).layui.admin.popupRight(h.extend({
                id: "layer-theme",
                url: i.url || "/static/tpl/tpl-theme.html"
        ...
        note: function() {
            ...
            n.strToWin(i.window).layui.admin.popupRight(h.extend({
                id: "layer-note",
                url: i.url || "/static/tpl/tpl-note.html"
            }, n.parseLayerOption(i)))
        },
        message: function() {
            var i = n.util.deepClone(h(this).data());
            n.strToWin(i.window).layui.admin.popupRight(h.extend({
                id: "layer-notice",
                url: i.url || "/static/tpl/tpl-message.html"
            }, n.parseLayerOption(i)))
        },
        psw: function() {
            var i = n.util.deepClone(h(this).data());
            n.strToWin(i.window).layui.admin.open(h.extend({
                ...
                title: "修改密码",
                shade: 0,
                url: i.url || "/static/tpl/tpl-password.html"
            }, n.parseLayerOption(i)))
        },
        logout: function() {
    ...
    n.lockScreen = function(q) {
        ...
        if (!q) {
            q = "/static/tpl/tpl-lock-screen.html"
        }
