...
class PdoHelper
{
	private $sqlPrefix = "lvxia_";//SQL数据表前缀识别字符
	private $db;
	...
	private function _select($table, $fields = '*', $where = array(), $sort = null, $limit = null){
		...
		$sql = ' FROM lvxia_'.$table.$conditions["_where"];
		if(is_array($limit)){
	...
	public function insert($table, $data){
		...
		$rowCount = $this->exec("INSERT INTO lvxia_".$table." (".implode(', ', $keys).") VALUES (".implode(', ', $marks).")", $values);
		if($rowCount){
	...
	public function update($table, $data, $where){
		...
		$conditions = $this->_where($where);
		$rowCount = $this->exec("UPDATE lvxia_".$table." SET ".$update.$conditions["_where"], $conditions["_bindParams"] + $values);
		return $rowCount;
	}
	...
	public function delete($table, $where){
		$conditions = $this->_where($where);
		$rowCount = $this->exec("DELETE FROM lvxia_".$table.$conditions["_where"], $conditions["_bindParams"]);
		return $rowCount;
	}
	...
	public function count($table, $where){
		$conditions = $this->_where($where);
		$count = $this->getColumn("SELECT COUNT(*) FROM lvxia_".$table.$conditions["_where"], $conditions["_bindParams"]);
		return $count;
	}
